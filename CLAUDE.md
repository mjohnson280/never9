...
1. **Code is cheap now. Solved problems are not.** When building was expensive, buying off the shelf and living with the gaps was rational; it is not anymore. A custom fix in weeks costs less than the workarounds. The value is in the problem solved, not the code. (Homepage "problem" section; "Code got cheap. Knowing what to build did not." heads the why-now section.)
